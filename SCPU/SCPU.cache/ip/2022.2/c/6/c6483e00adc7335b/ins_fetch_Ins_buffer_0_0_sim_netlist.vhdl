...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Ins_buffer is
  port (
    ins_out : out STD_LOGIC_VECTOR ( 5 downto 0 );
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Ins_buffer is
  ...
  signal \ins_out1_carry__0_n_5\ : STD_LOGIC;
  signal \ins_out1_carry__0_n_6\ : STD_LOGIC;
  signal \ins_out1_carry__0_n_7\ : STD_LOGIC;
  ...
  signal \ins_out[30]_i_2_n_0\ : STD_LOGIC;
  signal \ins_out[30]_i_3_n_0\ : STD_LOGIC;
  signal \ins_out[30]_i_4_n_0\ : STD_LOGIC;
  signal \ins_out[4]_i_1_n_0\ : STD_LOGIC;
  signal \ins_out[5]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \ins_out[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ins_out[28]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ins_out[29]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ins_out[30]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ins_out[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ins_out[5]_i_1\ : label is "soft_lutpair0";
begin
...
\ins_out1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2) => \ins_out1_carry__0_n_5\,
      O(1) => \ins_out1_carry__0_n_6\,
      O(0) => \ins_out1_carry__0_n_7\,
...
\ins_out[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00FD"
        ...
        port map (
      I0 => \ins_out[30]_i_3_n_0\,
      I1 => \ins_out[30]_i_4_n_0\,
      I2 => ins_out1_carry_n_6,
      I3 => rst,
      O => \ins_out[1]_i_1_n_0\
    );
\ins_out[28]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"002A"
    )
        port map (
      I0 => ins_out1_carry_n_7,
      I1 => ins_out1_carry_n_6,
      I2 => ins_out1_carry_n_5,
      I3 => \ins_out[30]_i_4_n_0\,
      O => \ins_out[28]_i_1_n_0\
    );
\ins_out[29]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"002A"
    )
        port map (
...
\ins_out[30]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => rst,
      I1 => \ins_out[30]_i_3_n_0\,
      O => \ins_out[30]_i_1_n_0\
    );
\ins_out[30]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"002A"
    )
        port map (
      I0 => ins_out1_carry_n_5,
      I1 => ins_out1_carry_n_7,
      I2 => ins_out1_carry_n_6,
      I3 => \ins_out[30]_i_4_n_0\,
      O => \ins_out[30]_i_2_n_0\
    );
\ins_out[30]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \ins_out1_carry__0_n_5\,
      I3 => \ins_out1_carry__0_n_4\,
      I4 => \ins_out1_carry__0_n_7\,
      I5 => \ins_out1_carry__0_n_6\,
      O => \ins_out[30]_i_3_n_0\
    );
\ins_out[30]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => \ins_out1_carry__0_n_7\,
      I1 => ins_out1_carry_n_4,
      I2 => \ins_out1_carry__0_n_5\,
      I3 => \ins_out1_carry__0_n_6\,
      O => \ins_out[30]_i_4_n_0\
    );
...
\ins_out[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      I0 => \ins_out1_carry__0_n_6\,
      I1 => \ins_out1_carry__0_n_5\,
      I2 => ins_out1_carry_n_4,
      I3 => \ins_out1_carry__0_n_7\,
      I4 => ins_out1_carry_n_6,
      O => \ins_out[5]_i_1_n_0\
    );
...
\ins_out_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \ins_out[5]_i_1_n_0\,
      Q => ins_out(2),
      R => \ins_out[30]_i_1_n_0\
    );
end STRUCTURE;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Ins_buffer
     port map (
      clk => clk,
      ins_out(5 downto 3) => \^ins_out\(26 downto 24),
      ins_out(2) => \^ins_out\(5),
      ins_out(1) => \^ins_out\(0),
      ins_out(0) => \^ins_out\(1),
