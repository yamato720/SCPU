...
-- Date        : Wed Nov  5 16:17:49 2025
-- Host        : Plana running 64-bit Arch Linux
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fetch_test_Ins_buffer_0_0_sim_netlist.vhdl
-- Design      : fetch_test_Ins_buffer_0_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Ins_buffer is
  port (
    ...
    rst : in STD_LOGIC;
    base_in : in STD_LOGIC_VECTOR ( 7 downto 0 );
    clk : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Ins_buffer is
  ...
  signal pc_base : STD_LOGIC_VECTOR ( 7 downto 0 );
...
ins_out1_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\ins_out1_carry_i_1__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
ins_out1_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\ins_out1_carry_i_2__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
ins_out1_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\ins_out1_carry_i_3__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
ins_out1_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\ins_out1_carry_i_4__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\pc_base_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(0),
...
\pc_base_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(1),
...
\pc_base_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(2),
...
\pc_base_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(3),
...
\pc_base_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(4),
...
\pc_base_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(5),
...
\pc_base_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(6),
...
\pc_base_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => rst,
      D => base_in(7),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "fetch_test_Ins_buffer_0_0,Ins_buffer,{}";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Ins_buffer
     port map (
      base_in(7 downto 0) => base_in(7 downto 0),
      clk => clk,
